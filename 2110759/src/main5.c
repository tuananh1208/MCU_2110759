...
void display7SEG1(int n) {
	...
	HAL_GPIO_WritePin(LED_7SEG_1_Port, SEG_1_A_Pin, (pattern >> 0) & 1);
	HAL_GPIO_WritePin(LED_7SEG_1_Port, SEG_1_B_Pin, (pattern >> 1) & 1);
	HAL_GPIO_WritePin(LED_7SEG_1_Port, SEG_1_C_Pin, (pattern >> 2) & 1);
	HAL_GPIO_WritePin(LED_7SEG_1_Port, SEG_1_D_Pin, (pattern >> 3) & 1);
	HAL_GPIO_WritePin(LED_7SEG_1_Port, SEG_1_E_Pin, (pattern >> 4) & 1);
	HAL_GPIO_WritePin(LED_7SEG_1_Port, SEG_1_F_Pin, (pattern >> 5) & 1);
	HAL_GPIO_WritePin(LED_7SEG_1_Port, SEG_1_G_Pin, (pattern >> 6) & 1);
}

void display7SEG2(int n) {
	uint8_t pattern = led_pattern[n];
	HAL_GPIO_WritePin(LED_7SEG_2_Port, SEG_2_A_Pin, (pattern >> 0) & 1);
	HAL_GPIO_WritePin(LED_7SEG_2_Port, SEG_2_B_Pin, (pattern >> 1) & 1);
	HAL_GPIO_WritePin(LED_7SEG_2_Port, SEG_2_C_Pin, (pattern >> 2) & 1);
	HAL_GPIO_WritePin(LED_7SEG_2_Port, SEG_2_D_Pin, (pattern >> 3) & 1);
	HAL_GPIO_WritePin(LED_7SEG_2_Port, SEG_2_E_Pin, (pattern >> 4) & 1);
	HAL_GPIO_WritePin(LED_7SEG_2_Port, SEG_2_F_Pin, (pattern >> 5) & 1);
	HAL_GPIO_WritePin(LED_7SEG_2_Port, SEG_2_G_Pin, (pattern >> 6) & 1);
}
/* USER CODE END 0 */
...
int main(void)
{
  ...
  enum led_state current_state, next_state;
  state = led1_yellow_led2_red;
  next_state = led1_red_led2_green;
  ...
  while (1)
  {
      ...
      switch (current_state) {
		    case led1_red_led2_green:
          setTimer1(200);
          next_state = led1_red_led2_yellow;
          counter1 = 2;
          counter2 = 2;
          ...
          break;
		    ...
		    case led1_red_led2_yellow:
			  setTimer1(300);
			  next_state = led1_green_led2_red;
			  counter1 = 3;
        counter2 = 5;
        ...
        break;
		    ...
		    case led1_green_led2_red:
			  setTimer1(200);
			  next_state = led1_yellow_led2_red;
			  counter1 = 2;
        counter2 = 2
